    ...
    <div class="hero">
      <div class="left">
        <?php
          ...
          $myposts = get_posts([ 
            'numberposts' =>
        1, 'category_name' => 'javascript, css, html, web-design', ]); if(
...
<div class="container">
  <ul class="article-list">
    <?php
      ...
      $myposts = get_posts([ 
        'numberposts' =>
    4, 'category_name' => 'articles', ]); if( $myposts ){ foreach( $myposts as
  ...
  <ul class="article-grid">
    <?php		
      ...
      $query = new WP_Query( [
        'posts_per_page' =>
    7, ] ); if ( $query->have_posts() ) { $cnt = 0; while ( $query->have_posts()
    ) { $query->the_post(); $cnt++; switch ($cnt) { case '1': ?>
    <li class="article-grid-item article-grid-item-1">
      <a href="<?php the_permalink()?>" class="article-grid-permalink">
        ...
        <p class="article-grid-excerpt">
          <?php echo mb_strimwidth(get_the_excerpt(), 0, 60, '...') ?>
        </p>
        ...
        <div class="article-grid-info">
          <div class="author">
            ...
            <div class="author-info">
              ...
              <div class="likes">
                <img
                  src="<?php echo get_template_directory_uri() . '/assets/images/like.svg' ?>"
                  alt="icon: like"
                  class="likes-icon"
                />
